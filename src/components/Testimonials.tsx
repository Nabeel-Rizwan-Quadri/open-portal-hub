    ...
    <section className="py-20 px-4">
      <div className="container mx-auto flex flex-col items-center justify-center">
        ...
        <p className="text-xl text-gray-400 mb-12 text-center max-w-2xl mx-auto animate-fade-in">
          We work with leading companies in Logistics, IT Services, Financial Services, Healthcare, Energy and Infrastructure.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <div className="p-6 border border-customGreen rounded-xl bg-slate-300   flex flex-col items-center animate-fade-in">
        ...
        <p className="text-xl text-gray-400 text-center max-w-5xl mx-auto animate-fade-in my-12">
        ...
        <Button size="lg" className="hover-lift animate-fade-in" onClick={() => navigate("/usecases")}>
          Explore Use Cases
        </Button>
